...
namespace UnityEngine.UI.Extensions {
	...
	public class UIPrimitiveBase : MaskableGraphic, ILayoutElement, ICanvasRaycastFilter {
		...
		public Sprite sprite { get => m_Sprite; set { if (SetPropertyUtility.SetClass(ref m_Sprite, value)) GeneratedUVs(); SetAllDirty(); } }

		[NonSerialized]
		private Sprite m_OverrideSprite;
		public Sprite overrideSprite { get => activeSprite; set { if (SetPropertyUtility.SetClass(ref m_OverrideSprite, value)) GeneratedUVs(); SetAllDirty(); } }
		...
		public float eventAlphaThreshold { get => m_EventAlphaThreshold; set => m_EventAlphaThreshold = value; }

		[SerializeField]
		private ResolutionMode m_improveResolution;
		public ResolutionMode ImproveResolution { get => m_improveResolution; set { m_improveResolution = value; SetAllDirty(); } }

		[SerializeField]
		protected float m_Resolution;
		public float Resolution { get => m_Resolution; set { m_Resolution = value; SetAllDirty(); } }
