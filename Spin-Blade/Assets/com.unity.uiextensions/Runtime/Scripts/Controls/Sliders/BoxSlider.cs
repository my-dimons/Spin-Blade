...
namespace UnityEngine.UI.Extensions
{
	...
	public class BoxSlider : Selectable, IDragHandler, IInitializePotentialDragHandler, ICanvasElement
	{
		...
		public RectTransform HandleRect { get => m_HandleRect; set { if (SetClass(ref m_HandleRect, value)) { UpdateCachedReferences(); UpdateVisuals(); } } }

		[Space(6)]

		[SerializeField]
		private float m_MinValue = 0;
		public float MinValue { get => m_MinValue; set { if (SetStruct(ref m_MinValue, value)) { SetX(m_ValueX); SetY(m_ValueY); UpdateVisuals(); } } }

		[SerializeField]
		private float m_MaxValue = 1;
		public float MaxValue { get => m_MaxValue; set { if (SetStruct(ref m_MaxValue, value)) { SetX(m_ValueX); SetY(m_ValueY); UpdateVisuals(); } } }

		[SerializeField]
		private bool m_WholeNumbers = false;
		public bool WholeNumbers { get => m_WholeNumbers; set { if (SetStruct(ref m_WholeNumbers, value)) { SetX(m_ValueX); SetY(m_ValueY); UpdateVisuals(); } } }
		...
		public BoxSliderEvent OnValueChanged { get => m_OnValueChanged; set => m_OnValueChanged = value; }
