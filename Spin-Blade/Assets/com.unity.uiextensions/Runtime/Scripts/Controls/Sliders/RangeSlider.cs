...
namespace UnityEngine.UI.Extensions {
	...
	public class RangeSlider : Selectable, IDragHandler, IInitializePotentialDragHandler, ICanvasElement {
		...
		public float NormalizedLowValue {
			...
			set => this.LowValue = Mathf.Lerp(MinValue, MaxValue, value);
		}
		...
		public float NormalizedHighValue {
			...
			set => this.HighValue = Mathf.Lerp(MinValue, MaxValue, value);
		}
		...
		public RangeSliderEvent OnValueChanged { get => m_OnValueChanged; set => m_OnValueChanged = value; }
