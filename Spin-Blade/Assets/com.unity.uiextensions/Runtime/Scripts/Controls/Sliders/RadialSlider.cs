...
namespace UnityEngine.UI.Extensions
{
	...
	public class RadialSlider : MonoBehaviour, IPointerEnterHandler, IPointerDownHandler, IPointerUpHandler, IDragHandler
	{
		...
		{
			get => m_endColor; set => m_endColor = value;
		}

		public Color StartColor
		{
			get => m_startColor; set => m_startColor = value;
		}

		public bool LerpToTarget
		{
			get => m_lerpToTarget; set => m_lerpToTarget = value;
		}
		...
		{
			get => _onTextValueChanged; set => _onTextValueChanged = value;
		}
